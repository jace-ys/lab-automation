...
class AddResourceDefBody(object):
    ...
    def __init__(self, resource_type_id=None, direction=None):  # noqa: E501
        """AddResourceDefBody - a model defined in Swagger"""  # noqa: E501
    ...
    def resource_type_id(self):
        """Gets the resource_type_id of this AddResourceDefBody.  # noqa: E501

        The `_id` of the resource type being added to the activity input or output..  # noqa: E501

        :return: The resource_type_id of this AddResourceDefBody.  # noqa: E501
        :rtype: str
        """
    ...
    def resource_type_id(self, resource_type_id):
        """Sets the resource_type_id of this AddResourceDefBody.

        The `_id` of the resource type being added to the activity input or output..  # noqa: E501

        :param resource_type_id: The resource_type_id of this AddResourceDefBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def direction(self):
        """Gets the direction of this AddResourceDefBody.  # noqa: E501

        The direction on the activity for the resource type. This will be one of: `input`, or `output`.  # noqa: E501

        :return: The direction of this AddResourceDefBody.  # noqa: E501
        :rtype: str
        """
    ...
    def direction(self, direction):
        """Sets the direction of this AddResourceDefBody.

        The direction on the activity for the resource type. This will be one of: `input`, or `output`.  # noqa: E501

        :param direction: The direction of this AddResourceDefBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AddResourceDefBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddResourceDefBody):
            return False
