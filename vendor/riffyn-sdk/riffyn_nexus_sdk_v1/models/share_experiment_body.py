...
class ShareExperimentBody(object):
    ...
    def __init__(self, principal_id=None, principal_type=None, role=None):  # noqa: E501
        """ShareExperimentBody - a model defined in Swagger"""  # noqa: E501
    ...
    def principal_id(self):
        """Gets the principal_id of this ShareExperimentBody.  # noqa: E501

        The id of the entity the experiment is being shared with.  # noqa: E501

        :return: The principal_id of this ShareExperimentBody.  # noqa: E501
        :rtype: str
        """
    ...
    def principal_id(self, principal_id):
        """Sets the principal_id of this ShareExperimentBody.

        The id of the entity the experiment is being shared with.  # noqa: E501

        :param principal_id: The principal_id of this ShareExperimentBody.  # noqa: E501
        :type: str
        """
    ...
    def principal_type(self):
        """Gets the principal_type of this ShareExperimentBody.  # noqa: E501

        The type of the entity the experiment is being shared with. Valid types are \"user\", \"team\", or \"org\".  # noqa: E501

        :return: The principal_type of this ShareExperimentBody.  # noqa: E501
        :rtype: str
        """
    ...
    def principal_type(self, principal_type):
        """Sets the principal_type of this ShareExperimentBody.

        The type of the entity the experiment is being shared with. Valid types are \"user\", \"team\", or \"org\".  # noqa: E501

        :param principal_type: The principal_type of this ShareExperimentBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def role(self):
        """Gets the role of this ShareExperimentBody.  # noqa: E501

        The role of the entity the experiment is being shared with. Valid roles are \"admin\", \"designer\", \"operator\", or \"viewer\".  # noqa: E501

        :return: The role of this ShareExperimentBody.  # noqa: E501
        :rtype: str
        """
        return self._role
    ...
    @role.setter
    def role(self, role):
        """Sets the role of this ShareExperimentBody.

        The role of the entity the experiment is being shared with. Valid roles are \"admin\", \"designer\", \"operator\", or \"viewer\".  # noqa: E501

        :param role: The role of this ShareExperimentBody.  # noqa: E501
        :type: str
        """
        if role is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ShareExperimentBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShareExperimentBody):
            return False
