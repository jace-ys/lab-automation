...
class OrgInner(object):
    ...
    def __init__(self, id=None, name=None):  # noqa: E501
        """OrgInner - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
    ...
    @property
    def id(self):
        """Gets the id of this OrgInner.  # noqa: E501

        The `_id` of the organization the entity belongs to.  # noqa: E501

        :return: The id of this OrgInner.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this OrgInner.

        The `_id` of the organization the entity belongs to.  # noqa: E501

        :param id: The id of this OrgInner.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this OrgInner.  # noqa: E501

        The `name` of the organization the entity belongs to.  # noqa: E501

        :return: The name of this OrgInner.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this OrgInner.

        The `name` of the organization the entity belongs to.  # noqa: E501

        :param name: The name of this OrgInner.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrgInner):
            return False
