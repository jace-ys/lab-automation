...
class AccessTokenBody(object):
    ...
    def __init__(self, time=None):  # noqa: E501
        """AccessTokenBody - a model defined in Swagger"""  # noqa: E501
        self._time = None
    ...
    @property
    def time(self):
        """Gets the time of this AccessTokenBody.  # noqa: E501

        The number of seconds the `accessToken` should be valid for. Default lifetime is 30 minutes (1800 seconds). Max lifetime is 6 hours (21600 seconds).  # noqa: E501

        :return: The time of this AccessTokenBody.  # noqa: E501
        :rtype: str
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this AccessTokenBody.

        The number of seconds the `accessToken` should be valid for. Default lifetime is 30 minutes (1800 seconds). Max lifetime is 6 hours (21600 seconds).  # noqa: E501

        :param time: The time of this AccessTokenBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AccessTokenBody, dict):
