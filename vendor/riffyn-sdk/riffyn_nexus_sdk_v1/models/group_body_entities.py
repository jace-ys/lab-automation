...
class GroupBodyEntities(object):
    ...
    def __init__(self, id=None, type=None):  # noqa: E501
        """GroupBodyEntities - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._type = None
    ...
    @property
    def id(self):
        """Gets the id of this GroupBodyEntities.  # noqa: E501

        The `_id` of the entity to be included inside the group being created.  # noqa: E501

        :return: The id of this GroupBodyEntities.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this GroupBodyEntities.

        The `_id` of the entity to be included inside the group being created.  # noqa: E501

        :param id: The id of this GroupBodyEntities.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this GroupBodyEntities.  # noqa: E501

        The `type` of the entity to be included inside the group being created. Will be one of `activity` or `group`.  # noqa: E501

        :return: The type of this GroupBodyEntities.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this GroupBodyEntities.

        The `type` of the entity to be included inside the group being created. Will be one of `activity` or `group`.  # noqa: E501

        :param type: The type of this GroupBodyEntities.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GroupBodyEntities, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GroupBodyEntities):
            return False
