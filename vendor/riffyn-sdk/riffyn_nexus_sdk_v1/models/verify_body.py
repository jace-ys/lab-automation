...
class VerifyBody(object):
    ...
    def __init__(self, state_token=None, pass_code=None):  # noqa: E501
    ...
    def state_token(self):
        """Gets the state_token of this VerifyBody.  # noqa: E501

        The state token for the current transaction. Returned by the `authenticate` endpoint.   # noqa: E501

        :return: The state_token of this VerifyBody.  # noqa: E501
        :rtype: str
        """
    ...
    def state_token(self, state_token):
        """Sets the state_token of this VerifyBody.

        The state token for the current transaction. Returned by the `authenticate` endpoint.   # noqa: E501

        :param state_token: The state_token of this VerifyBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def pass_code(self):
        """Gets the pass_code of this VerifyBody.  # noqa: E501

        The `passCode` from Google Authenticator.  # noqa: E501

        :return: The pass_code of this VerifyBody.  # noqa: E501
        :rtype: str
        """
    ...
    def pass_code(self, pass_code):
        """Sets the pass_code of this VerifyBody.

        The `passCode` from Google Authenticator.  # noqa: E501

        :param pass_code: The pass_code of this VerifyBody.  # noqa: E501
        :type: str
        """
        if pass_code is None:
            raise ValueError("Invalid value for `pass_code`, must not be `None`")  # noqa: E501
