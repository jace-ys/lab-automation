...
class RunStatus(object):
    ...
    def __init__(self, status=None, start=None, end=None, duration=None):  # noqa: E501
    ...
    def status(self):
        ...
        The status of the run: `new`, `running`, `stopped`, `completed`, `deleted`.  # noqa: E501
    ...
    @property
    def start(self):
        """Gets the start of this RunStatus.  # noqa: E501

        The date and time the run started on.  # noqa: E501

        :return: The start of this RunStatus.  # noqa: E501
        :rtype: datetime
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this RunStatus.

        The date and time the run started on.  # noqa: E501

        :param start: The start of this RunStatus.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def end(self):
        """Gets the end of this RunStatus.  # noqa: E501

        The date and time the run ended on.  # noqa: E501

        :return: The end of this RunStatus.  # noqa: E501
        :rtype: datetime
        """
        return self._end
    ...
    @end.setter
    def end(self, end):
        """Sets the end of this RunStatus.

        The date and time the run ended on.  # noqa: E501

        :param end: The end of this RunStatus.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def duration(self):
        """Gets the duration of this RunStatus.  # noqa: E501

        The duration of the run in milliseconds.  # noqa: E501

        :return: The duration of this RunStatus.  # noqa: E501
        :rtype: float
        """
    ...
    def duration(self, duration):
        """Sets the duration of this RunStatus.

        The duration of the run in milliseconds.  # noqa: E501

        :param duration: The duration of this RunStatus.  # noqa: E501
        :type: float
        """
