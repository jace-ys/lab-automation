...
class CommentMessageBody(object):
    ...
    def __init__(self, message=None):  # noqa: E501
        """CommentMessageBody - a model defined in Swagger"""  # noqa: E501
        self._message = None
    ...
    @property
    def message(self):
        """Gets the message of this CommentMessageBody.  # noqa: E501

        The body of the reply.  # noqa: E501

        :return: The message of this CommentMessageBody.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this CommentMessageBody.

        The body of the reply.  # noqa: E501

        :param message: The message of this CommentMessageBody.  # noqa: E501
        :type: str
        """
        if message is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CommentMessageBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CommentMessageBody):
            return False
