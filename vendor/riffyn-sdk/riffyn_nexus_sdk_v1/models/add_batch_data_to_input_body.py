...
class AddBatchDataToInputBody(object):
    ...
    """
    swagger_types = {
        'batch_data': 'list[AddDataToInputBody]'
    }
    ...
    def __init__(self, batch_data=None):  # noqa: E501
        """AddBatchDataToInputBody - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def batch_data(self):
        """Gets the batch_data of this AddBatchDataToInputBody.  # noqa: E501

        A set of objects to add data to multiple properties that follow the addRunData format.  # noqa: E501

        :return: The batch_data of this AddBatchDataToInputBody.  # noqa: E501
        :rtype: list[AddDataToInputBody]
        """
        return self._batch_data

    @batch_data.setter
    def batch_data(self, batch_data):
        """Sets the batch_data of this AddBatchDataToInputBody.

        A set of objects to add data to multiple properties that follow the addRunData format.  # noqa: E501

        :param batch_data: The batch_data of this AddBatchDataToInputBody.  # noqa: E501
        :type: list[AddDataToInputBody]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AddBatchDataToInputBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddBatchDataToInputBody):
            return False
