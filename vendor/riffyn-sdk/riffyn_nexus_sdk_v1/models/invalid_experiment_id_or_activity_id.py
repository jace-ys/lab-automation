...
class InvalidExperimentIdOrActivityId(object):
    ...
    def __init__(self, error=None):  # noqa: E501
        """InvalidExperimentIdOrActivityId - a model defined in Swagger"""  # noqa: E501
        self._error = None
    ...
    @property
    def error(self):
        """Gets the error of this InvalidExperimentIdOrActivityId.  # noqa: E501

        Invalid experiment ID or activity ID  # noqa: E501

        :return: The error of this InvalidExperimentIdOrActivityId.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this InvalidExperimentIdOrActivityId.

        Invalid experiment ID or activity ID  # noqa: E501

        :param error: The error of this InvalidExperimentIdOrActivityId.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InvalidExperimentIdOrActivityId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InvalidExperimentIdOrActivityId):
            return False
