...
class NewResourceTypeBodyProperties(object):
    ...
    def __init__(self, id=None):  # noqa: E501
        """NewResourceTypeBodyProperties - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this NewResourceTypeBodyProperties.  # noqa: E501

        A valid property type `_id`. If any one of these values is invalid, an error will be returned.  # noqa: E501

        :return: The id of this NewResourceTypeBodyProperties.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this NewResourceTypeBodyProperties.

        A valid property type `_id`. If any one of these values is invalid, an error will be returned.  # noqa: E501

        :param id: The id of this NewResourceTypeBodyProperties.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NewResourceTypeBodyProperties, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NewResourceTypeBodyProperties):
            return False
