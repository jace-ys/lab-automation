...
class NewResourceBodyComponents(object):
    ...
    def __init__(self, id=None, name=None):  # noqa: E501
        """NewResourceBodyComponents - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
    ...
    @property
    def id(self):
        """Gets the id of this NewResourceBodyComponents.  # noqa: E501

        The `_id` of the resource type associated with this component.  # noqa: E501

        :return: The id of this NewResourceBodyComponents.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this NewResourceBodyComponents.

        The `_id` of the resource type associated with this component.  # noqa: E501

        :param id: The id of this NewResourceBodyComponents.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this NewResourceBodyComponents.  # noqa: E501

        The `name` of the resource type associated with this component.  # noqa: E501

        :return: The name of this NewResourceBodyComponents.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this NewResourceBodyComponents.

        The `name` of the resource type associated with this component.  # noqa: E501

        :param name: The name of this NewResourceBodyComponents.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NewResourceBodyComponents, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NewResourceBodyComponents):
            return False
