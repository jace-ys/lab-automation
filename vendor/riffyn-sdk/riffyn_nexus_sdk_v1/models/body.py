...
class Body(object):
    ...
    def id(self):
        ...
        The `_id` of the tag being added. If no `_id` is provided the tag will be found using the `name`.   # noqa: E501
    ...
    def name(self):
        ...
        The name of the tag. The `name` must be defined if the `_id` is not provided or if the tag is new.   # noqa: E501
