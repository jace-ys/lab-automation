...
class ResourcesProperties(object):
    ...
    def __init__(self, id=None, name=None, value=None):  # noqa: E501
        """ResourcesProperties - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
        self._value = None
    ...
    @property
    def id(self):
        """Gets the id of this ResourcesProperties.  # noqa: E501

        The `_id` of the property.  # noqa: E501

        :return: The id of this ResourcesProperties.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ResourcesProperties.

        The `_id` of the property.  # noqa: E501

        :param id: The id of this ResourcesProperties.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this ResourcesProperties.  # noqa: E501

        The `name` of the property.  # noqa: E501

        :return: The name of this ResourcesProperties.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ResourcesProperties.

        The `name` of the property.  # noqa: E501

        :param name: The name of this ResourcesProperties.  # noqa: E501
        :type: str
        """
    ...
    @property
    def value(self):
        """Gets the value of this ResourcesProperties.  # noqa: E501

        The `value` of the property.  # noqa: E501

        :return: The value of this ResourcesProperties.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this ResourcesProperties.

        The `value` of the property.  # noqa: E501

        :param value: The value of this ResourcesProperties.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResourcesProperties, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResourcesProperties):
            return False
