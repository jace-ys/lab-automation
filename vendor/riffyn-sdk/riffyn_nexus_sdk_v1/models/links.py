...
class Links(object):
    ...
    def first(self):
        ...
        The URL to retrieve the first page of the current result set. If the current result set is the first page, or there's only one page of results, this value will not be returned.  # noqa: E501
    ...
    def prev(self):
        ...
        The URL to retrieve the previous page from the current result set. If the current result set is the first page, or there's only one page of results, this value will not be returned.  # noqa: E501
    ...
    def next(self):
        ...
        The URL to retrieve the next page from the current result set. If the current result set is the last page, or there's only one page of results, this value will not be returned.  # noqa: E501
    ...
    def last(self):
        ...
        The URL to retrieve the last page of the current result set. If the current result set is the last page, or there's only one page of results, this value will not be returned.  # noqa: E501
