...
class UploadFileResponse(object):
    ...
    def __init__(self, data_file_id=None):  # noqa: E501
    ...
    def data_file_id(self):
        """Gets the data_file_id of this UploadFileResponse.  # noqa: E501

        The `_id` for the uploaded file. This is the `_id` to pass in on the `applyUploadConfig` endpoint.  # noqa: E501

        :return: The data_file_id of this UploadFileResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def data_file_id(self, data_file_id):
        """Sets the data_file_id of this UploadFileResponse.

        The `_id` for the uploaded file. This is the `_id` to pass in on the `applyUploadConfig` endpoint.  # noqa: E501

        :param data_file_id: The data_file_id of this UploadFileResponse.  # noqa: E501
        :type: str
        """
