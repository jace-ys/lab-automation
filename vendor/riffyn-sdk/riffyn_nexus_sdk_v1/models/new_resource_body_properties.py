...
class NewResourceBodyProperties(object):
    ...
    def __init__(self, id=None, value=None):  # noqa: E501
        """NewResourceBodyProperties - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._value = None
    ...
    @property
    def id(self):
        """Gets the id of this NewResourceBodyProperties.  # noqa: E501

        A valid property type `_id`. If any one of these values is invalid, an error will be returned.  # noqa: E501

        :return: The id of this NewResourceBodyProperties.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this NewResourceBodyProperties.

        A valid property type `_id`. If any one of these values is invalid, an error will be returned.  # noqa: E501

        :param id: The id of this NewResourceBodyProperties.  # noqa: E501
        :type: str
        """
    ...
    @property
    def value(self):
        """Gets the value of this NewResourceBodyProperties.  # noqa: E501

        The value of this property, in string format. The string will be converted to the data type defined by the given property  # noqa: E501

        :return: The value of this NewResourceBodyProperties.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this NewResourceBodyProperties.

        The value of this property, in string format. The string will be converted to the data type defined by the given property  # noqa: E501

        :param value: The value of this NewResourceBodyProperties.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NewResourceBodyProperties, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NewResourceBodyProperties):
            return False
