...
class Body1(object):
    ...
    def name(self):
        ...
        The name you would like to give the new experiment. If no name is provided, the name of the source. experiment will be used, with the string ` (copy)` appended to the end.   # noqa: E501
    ...
    def description(self):
        ...
        A description for the new experiment. If no description is provided, the description of the source experiment will be used.   # noqa: E501
