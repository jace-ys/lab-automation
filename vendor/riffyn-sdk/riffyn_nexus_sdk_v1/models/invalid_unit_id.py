...
class InvalidUnitID(object):
    ...
    def __init__(self, error=None):  # noqa: E501
        """InvalidUnitID - a model defined in Swagger"""  # noqa: E501
        self._error = None
    ...
    @property
    def error(self):
        """Gets the error of this InvalidUnitID.  # noqa: E501

        description: Invalid resource ID.  # noqa: E501

        :return: The error of this InvalidUnitID.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this InvalidUnitID.

        description: Invalid resource ID.  # noqa: E501

        :param error: The error of this InvalidUnitID.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InvalidUnitID, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InvalidUnitID):
            return False
