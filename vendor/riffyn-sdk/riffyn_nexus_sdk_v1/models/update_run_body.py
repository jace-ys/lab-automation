...
class UpdateRunBody(object):
    ...
    def __init__(self, name=None, description=None, type=None):  # noqa: E501
        """UpdateRunBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this UpdateRunBody.  # noqa: E501

        The name for the run.  # noqa: E501

        :return: The name of this UpdateRunBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UpdateRunBody.

        The name for the run.  # noqa: E501

        :param name: The name of this UpdateRunBody.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this UpdateRunBody.  # noqa: E501

        The description of the run being updated.  # noqa: E501

        :return: The description of this UpdateRunBody.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this UpdateRunBody.

        The description of the run being updated.  # noqa: E501

        :param description: The description of this UpdateRunBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this UpdateRunBody.  # noqa: E501

        Allowed values are `blank`, `calibration`, `reference`, `sample`, `standard`, `trial`  # noqa: E501

        :return: The type of this UpdateRunBody.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this UpdateRunBody.

        Allowed values are `blank`, `calibration`, `reference`, `sample`, `standard`, `trial`  # noqa: E501

        :param type: The type of this UpdateRunBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateRunBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateRunBody):
            return False
