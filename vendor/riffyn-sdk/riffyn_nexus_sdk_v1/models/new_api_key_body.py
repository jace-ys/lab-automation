...
class NewApiKeyBody(object):
    ...
    def __init__(self, name=None):  # noqa: E501
        """NewApiKeyBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this NewApiKeyBody.  # noqa: E501

        The `name` for the api key being created. Each key must have a unique name.  # noqa: E501

        :return: The name of this NewApiKeyBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this NewApiKeyBody.

        The `name` for the api key being created. Each key must have a unique name.  # noqa: E501

        :param name: The name of this NewApiKeyBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NewApiKeyBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NewApiKeyBody):
            return False
