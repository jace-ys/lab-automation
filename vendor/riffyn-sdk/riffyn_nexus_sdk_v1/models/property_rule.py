...
class PropertyRule(object):
    ...
    """
    swagger_types = {
        'intrument_type_id': 'str',
        'label': 'str'
    }

    attribute_map = {
        'intrument_type_id': 'intrumentTypeId',
        'label': 'label'
    }

    def __init__(self, intrument_type_id=None, label=None):  # noqa: E501
        """PropertyRule - a model defined in Swagger"""  # noqa: E501
        self._intrument_type_id = None
        self._label = None
        self.discriminator = None
        if intrument_type_id is not None:
            self.intrument_type_id = intrument_type_id
        if label is not None:
            self.label = label

    @property
    def intrument_type_id(self):
        """Gets the intrument_type_id of this PropertyRule.  # noqa: E501


        :return: The intrument_type_id of this PropertyRule.  # noqa: E501
        :rtype: str
        """
        return self._intrument_type_id

    @intrument_type_id.setter
    def intrument_type_id(self, intrument_type_id):
        """Sets the intrument_type_id of this PropertyRule.


        :param intrument_type_id: The intrument_type_id of this PropertyRule.  # noqa: E501
        :type: str
        """

        self._intrument_type_id = intrument_type_id

    @property
    def label(self):
        """Gets the label of this PropertyRule.  # noqa: E501


        :return: The label of this PropertyRule.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this PropertyRule.


        :param label: The label of this PropertyRule.  # noqa: E501
        :type: str
        """
