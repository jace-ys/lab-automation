...
class ApplyConfigCollectionResponse(object):
    ...
    def __init__(self, task_ids=None):  # noqa: E501
        """ApplyConfigCollectionResponse - a model defined in Swagger"""  # noqa: E501
        self._task_ids = None
    ...
    @property
    def task_ids(self):
        """Gets the task_ids of this ApplyConfigCollectionResponse.  # noqa: E501

        The `_id` of the task for the specific dataFile with upload configration parsing.  # noqa: E501

        :return: The task_ids of this ApplyConfigCollectionResponse.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def task_ids(self, task_ids):
        """Sets the task_ids of this ApplyConfigCollectionResponse.

        The `_id` of the task for the specific dataFile with upload configration parsing.  # noqa: E501

        :param task_ids: The task_ids of this ApplyConfigCollectionResponse.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApplyConfigCollectionResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApplyConfigCollectionResponse):
            return False
