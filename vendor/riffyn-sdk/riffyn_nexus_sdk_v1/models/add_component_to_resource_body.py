...
class AddComponentToResourceBody(object):
    ...
    def __init__(self, id=None):  # noqa: E501
        """AddComponentToResourceBody - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this AddComponentToResourceBody.  # noqa: E501

        The `_id` of the component to be added to the resource.  # noqa: E501

        :return: The id of this AddComponentToResourceBody.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this AddComponentToResourceBody.

        The `_id` of the component to be added to the resource.  # noqa: E501

        :param id: The id of this AddComponentToResourceBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AddComponentToResourceBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddComponentToResourceBody):
            return False
