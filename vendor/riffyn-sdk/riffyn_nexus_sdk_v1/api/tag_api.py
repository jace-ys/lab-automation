...
class TagApi(object):
    ...
    def create_tag(self, body, **kwargs):  # noqa: E501
        ...
        Create a tag for the user.  # noqa: E501
        ...
        :param TagBody body: A JSON object containing the necessary properties to create a new tag. (required)
        :return: Tag
    ...
    def delete_tag(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str id: The `_id` of the tag. (required)
    ...
    def get_tag(self, id, **kwargs):  # noqa: E501
        ...
        Returns the detail for the specified tag.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_entities_for_tag(self, id, **kwargs):  # noqa: E501
        """listEntitiesForTag  # noqa: E501

        Returns all the entities with the specified tag.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_entities_for_tag(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: The `_id` of the tag. (required)
        :return: EntitiesForTag
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_entities_for_tag_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.list_entities_for_tag_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def list_entities_for_tag_with_http_info(self, id, **kwargs):  # noqa: E501
        """listEntitiesForTag  # noqa: E501

        Returns all the entities with the specified tag.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_entities_for_tag_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_entities_for_tag" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `list_entities_for_tag`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='EntitiesForTag',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_tags(self, **kwargs):  # noqa: E501
        ...
        Returns all tags for the user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_tags_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'fields', 'creator', 'sort', 'limit', 'offset', 'before', 'after', 'modified_before', 'modified_after', 'public']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_tag(self, body, id, **kwargs):  # noqa: E501
        """updateTag  # noqa: E501

        Update an existing tag.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_tag(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param TagBody body: A JSON object containing the necessary properties to update a tag. (required)
        :param str id: The `_id` of the tag. (required)
        :return: Tag
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_tag_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_tag_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_tag_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """updateTag  # noqa: E501

        Update an existing tag.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_tag_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
