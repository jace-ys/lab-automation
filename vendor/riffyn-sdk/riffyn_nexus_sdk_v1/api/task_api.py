...
class TaskApi(object):
    ...
    def list_tasks(self, **kwargs):  # noqa: E501
        ...
        :param str state: Limits the records returned to the ones that are in a specific state. Will be one of: `new`, `initializing`, `initialized`, `wip`, `success`, or `failed`. 
